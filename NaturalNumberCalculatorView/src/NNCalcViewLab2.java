 ...
 * @author Baowen Liu
 */
public final class NNCalcViewLab2 extends JFrame implements ActionListener {
...
//            buttonPanel.add(this.digButton[i]);
//        }
        buttonPanel.add(this.digButton[7]);
        buttonPanel.add(this.digButton[8]);
        buttonPanel.add(this.digButton[9]);
        buttonPanel.add(this.bAdd);
        buttonPanel.add(this.digButton[4]);
        buttonPanel.add(this.digButton[5]);
        buttonPanel.add(this.digButton[6]);
        buttonPanel.add(this.bSubtract);
        buttonPanel.add(this.digButton[1]);
        buttonPanel.add(this.digButton[2]);
        buttonPanel.add(this.digButton[3]);
         ...
         */
        JPanel sideButtonPanel = new JPanel(new GridLayout(MAIN_BUTTON_PANEL_GRID_ROWS,
                MAIN_BUTTON_PANEL_GRID_COLUMNS));
    ...
    public static void main(String[] args) {
        NNCalcViewLab2 view = new NNCalcViewLab2();
    }
