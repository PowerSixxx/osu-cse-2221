...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        // Set disabled to divide and root at first
         ...
         */
        // Create the actual button panel for all of the buttons
         ...
         */
        // Create side panel for buttons such as enter, clear, swap
         ...
         * to bottom
         */
        // Add the final buttons for the side button panel
         ...
         */
        // Detect the button (ActionListener)
        ...
        for (int i = 0; i < NaturalNumber.RADIX; i++) {
    ...
    // Enable or disable the "Subtract" button based on the given boolean
    @Override
    public void updateSubtractAllowed(boolean allowed) {
        this.bSubtract.setEnabled(allowed);
    }

    // Enable or disable the "Divide" button based on the given boolean
    @Override
    public void updateDivideAllowed(boolean allowed) {
        this.bDivide.setEnabled(allowed);
    }

    // Enable or disable the "Power" button based on the given boolean
    @Override
    public void updatePowerAllowed(boolean allowed) {
        this.bPower.setEnabled(allowed);
    }

    // Enable or disable the "Root" button based on the given boolean
    @Override
